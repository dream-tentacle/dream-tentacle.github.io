...
const issues = [
  ...
  {
    stateID: 321,
    logText: "我已完成质变（每年消耗金钱-1）",
    nextStates: [{ possibility: 2.0, stateID: 0 }],
    insertEnd: true,
  },
  {
    stateID: 322,
    logText: "我已升华（每年消耗金钱-1）",
    nextStates: [{ possibility: 2.0, stateID: 0 }],
    insertEnd: true,
  },
  {
    stateID: 323,
    logText: "我几乎不在是人类（每年消耗金钱-1）",
    nextStates: [{ possibility: 2.0, stateID: 0 }],
    insertEnd: true,
  },
  {
  ...
  {
    stateID: 751,
    logText: "夫心之性相，可令樯倾楫摧，山崩地裂，存诸生灵，然鲜或得以用之",
    nextStates: [{ possibility: 2.0, stateID: 752 }],
  },
  {
    stateID: 752,
    logText: "善相为大，在于命中，而可使人为深",
  ...
  {
    stateID: 755,
    logText: "深与心相及者，其能抵欲养内，若自任者，尽于性相之力。",
    nextStates: [{ possibility: 2.0, stateID: 756 }],
  },
  {
    stateID: 756,
    logText: "究其质，乃生灵内在之力，为天下渴力之欲，",
  ...
  {
    stateID: 758,
    logText: "古书记之，源于渊，始于微，发于暗，见于明，非轻力之所使也。",
    nextStates: [{ possibility: 2.0, stateID: 759 }],
  },
  {
    stateID: 759,
    logText: "其相者当慎思其潜藏之暗，其源不测渊也。",
    nextStates: [{ possibility: 2.0, stateID: 200 }],
  },
  {
    stateID: 760,
  ...
  {
    stateID: 770,
    logText: "夫追随珠之性相者，或可获益，亦或危殆。",
    nextStates: [{ possibility: 2.0, stateID: 771 }],
  },
  {
    stateID: 771,
    logText: "一者，充实学者技能，强其掌握，以为遂己之器",
    nextStates: [{ possibility: 2.0, stateID: 772 }],
  },
  {
    stateID: 772,
    logText: "二者，此易固执、求全，或致追求者步入危险、潜藏破坏性之途。",
    nextStates: [{ possibility: 2.0, stateID: 773 }],
  },
  {
    stateID: 773,
    logText: "倘过于追求技术之完美，修习之水平，则或疏远于世俗，而失现世之关联，",
    nextStates: [{ possibility: 2.0, stateID: 774 }],
  },
  {
    stateID: 774,
    logText: "或为工艺所迷，忘其身心之健康。",
    nextStates: [{ possibility: 2.0, stateID: 775 }],
  },
  {
    stateID: 775,
    logText: "甚或断绝魂肉之连结，魂飞魄散。",
    nextStates: [{ possibility: 2.0, stateID: 776 }],
  },
  {
    stateID: 776,
    logText: "且有神秘之存，或利珠之从徒，纵其求知，不避禁忌，遂以传授，或致狂变。",
    nextStates: [{ possibility: 2.0, stateID: 778 }],
  },
  {
    stateID: 777,
    logText: "古有《奇邪》之书，志世间之奇邪，载之：",
    nextStates: [{ possibility: 2.0, stateID: 778 }],
  },
  {
    stateID: 778,
    logText: "曩有一押捕，偶获珠性之法，",
    nextStates: [{ possibility: 2.0, stateID: 779 }],
  },
  {
    stateID: 779,
    logText: "因受禁忌之知，致军巡铺俱为毁灭。",
    nextStates: [{ possibility: 2.0, stateID: 780 }],
  },
  {
    stateID: 780,
    logText: "言而总之，珠之性相，固为从者之重器，亦为求者之危险。",
    nextStates: [{ possibility: 2.0, stateID: 781 }],
  },
  {
    stateID: 781,
    logText: "当慎之惕之，勿耽于技艺，需常存谨慎，无忘潜伏阴影之邪。",
    nextStates: [{ possibility: 2.0, stateID: 200 }],
  },
  {
    stateID: 782,
    logText: "我开始执行书中的仪式“暗影之眼”——",
    nextStates: [{ possibility: 2.0, stateID: 783 }],
  },
  {
    stateID: 783,
    logText: "【一张画有暗影之眼的仪式牌】",
    nextStates: [{ possibility: 2.0, stateID: 784 }],
  },
  {
    stateID: 784,
    logText: "【一支白蜡烛和一支黑蜡烛】",
    nextStates: [{ possibility: 2.0, stateID: 785 }],
  },
  {
    stateID: 785,
    logText: "【一瓶龙睛草油】",
    nextStates: [{ possibility: 2.0, stateID: 786 }],
  },
  {
    stateID: 786,
    logText: "【一把刀】",
    nextStates: [{ possibility: 2.0, stateID: 787 }],
  },
  {
    stateID: 787,
    logText: "在一个安静、没有打扰的地方，我点燃了白蜡烛和黑蜡烛。",
    nextStates: [{ possibility: 2.0, stateID: 788 }],
  },
  {
    stateID: 788,
    logText: "我将牌放在白蜡烛和黑蜡烛之间。",
    nextStates: [{ possibility: 2.0, stateID: 789 }],
  },
  {
    stateID: 789,
    logText: "我将一些龙睛草油滴在右手的手掌上，然后用手指点在自己的额头上。",
    nextStates: [{ possibility: 2.0, stateID: 790 }],
  },
  {
    stateID: 790,
    logText: "我拿起刀，沿着自己的左手臂划一道浅浅的伤口。",
    nextStates: [{ possibility: 2.0, stateID: 791 }],
  },
  {
    stateID: 791,
    logText: "用流出的血涂在代表目之性相的暗影之眼牌上。",
    nextStates: [{ possibility: 2.0, stateID: 792 }],
  },
  {
    stateID: 792,
    logText: "我闭上眼睛，静静地感受代表目之性相的牌所带来的力量。",
    nextStates: [{ possibility: 2.0, stateID: 793 }],
  },
  {
    stateID: 793,
    logText: "我面向仪式牌，拜请盲目之神，请求它赐予自己更强大的目之力量。",
    nextStates: [{ possibility: 2.0, stateID: 794 }],
  },
  {
    stateID: 794,
    logText: "等到白蜡烛和黑蜡烛烧完后，我将仪式牌藏在了一个安全的地方。",
    nextStates: [{ possibility: 2.0, stateID: 321 }],
  },
  {
    stateID: 795,
    logText: "我开始执行书中的仪式“观者的守夜”——",
    nextStates: [{ possibility: 2.0, stateID: 796 }],
  },
  {
    stateID: 796,
    logText: "【一根蜡烛】",
    nextStates: [{ possibility: 2.0, stateID: 797 }],
  },
  {
    stateID: 797,
    logText: "【一面镜子】",
    nextStates: [{ possibility: 2.0, stateID: 798 }],
  },
  {
    stateID: 798,
    logText: "【一张纸】",
    nextStates: [{ possibility: 2.0, stateID: 799 }],
  },
  {
    stateID: 799,
    logText: "【一支鹅毛笔】",
    nextStates: [{ possibility: 2.0, stateID: 800 }],
  },
  {
    stateID: 800,
    logText: "我点燃蜡烛，将其放在镜子前。",
    nextStates: [{ possibility: 2.0, stateID: 801 }],
  },
  {
    stateID: 801,
    logText: "坐在镜子前，凝视着自己的倒影",
    nextStates: [{ possibility: 2.0, stateID: 802 }],
  },
  {
    stateID: 802,
    logText: "我专注于镜像中的眼睛，并将其想象为通往隐藏的知识领域的入口。",
    nextStates: [{ possibility: 2.0, stateID: 803 }],
  },
  {
    stateID: 803,
    logText: "拿起鹅毛笔，在纸上记录下我脑中的洞见",
    nextStates: [{ possibility: 2.0, stateID: 804 }],
  },
  {
    stateID: 804,
    logText: "嘴唇翕动，我轻声念道：",
    nextStates: [{ possibility: 2.0, stateID: 805 }],
  },
  {
    stateID: 805,
    logText: "“透过预言者的眼睛，我将看到未见之物”",
    nextStates: [{ possibility: 2.0, stateID: 806 }],
  },
  {
    stateID: 806,
    logText: "“通过目之性相的力量，我将获得智慧”",
    nextStates: [{ possibility: 2.0, stateID: 807 }],
  },
  {
    stateID: 807,
    logText: "“经过这个仪式，我将加深对隐藏领域的理解”",
    nextStates: [{ possibility: 2.0, stateID: 808 }],
  },
  {
    stateID: 808,
    logText: "我沉默着——",
    nextStates: [
      { possibility: 0.25, stateID: 808 },
      { possibility: 0.25, stateID: 809 },
      { possibility: 0.25, stateID: 810 },
      { possibility: 2.0, stateID: 811 },
    ],
  },
  {
    stateID: 809,
  ...
  },
  {
    ...
    logText: "我思索着——",
    nextStates: [
      { possibility: 0.1, stateID: 808 },
      { possibility: 0.1, stateID: 809 },
      { possibility: 0.1, stateID: 810 },
      { possibility: 2.0, stateID: 812 },
    ],
  },
  {
    stateID: 812,
    logText: "仪式结束。",
    nextStates: [{ possibility: 2.0, stateID: 322 }],
  },
  {
    stateID: 813,
    logText: "按照书中记录，我将复现洞察之神蜕化为盲目之神的过程——（可能引起不适）",
    nextStates: [{ possibility: 2.0, stateID: 814 }],
    skipStateID: 830,
  },
  {
    stateID: 814,
    logText: "【七根蜡烛】",
    nextStates: [{ possibility: 2.0, stateID: 815 }],
    skipStateID: 830,
  },
  {
    stateID: 815,
    logText: "【两块黑布】",
    nextStates: [{ possibility: 2.0, stateID: 816 }],
    skipStateID: 830,
  },
  {
    stateID: 816,
    logText: "【一把我常用的仪式刀】",
    nextStates: [{ possibility: 2.0, stateID: 817 }],
    skipStateID: 830,
  },
  {
    stateID: 817,
    logText: "我在黑布上将七根蜡烛排成一个圆圈",
    nextStates: [{ possibility: 2.0, stateID: 818 }],
    skipStateID: 830,
  },
  {
    stateID: 818,
    logText: "从我的对面开始逆时针点燃蜡烛",
    nextStates: [{ possibility: 2.0, stateID: 819 }],
    skipStateID: 830,
  },
  {
    stateID: 819,
    logText: "闭上眼睛，清空思绪，专注呼吸",
    nextStates: [{ possibility: 2.0, stateID: 820 }],
    skipStateID: 830,
  },
  {
    stateID: 820,
    logText: "我摸索着，将仪式刀依次插入蜡烛中，将其切断",
    nextStates: [{ possibility: 2.0, stateID: 821 }],
    skipStateID: 830,
  },
  {
    stateID: 821,
    logText: "然后用第二块黑布包着仪式刀，",
    nextStates: [{ possibility: 2.0, stateID: 822 }],
    skipStateID: 830,
  },
  {
    stateID: 822,
    logText: "猛地将仪式刀插入右眼，",
    nextStates: [{ possibility: 2.0, stateID: 823 }],
    skipStateID: 830,
  },
  {
    stateID: 823,
    logText: "眼球爆开，",
    nextStates: [{ possibility: 2.0, stateID: 824 }],
    skipStateID: 830,
  },
  {
    stateID: 824,
    logText: "鲜血四溅，",
    nextStates: [{ possibility: 2.0, stateID: 825 }],
    skipStateID: 830,
  },
  {
    stateID: 825,
    logText: "一股尖锐的剧痛刺入大脑。",
    nextStates: [{ possibility: 2.0, stateID: 826 }],
    skipStateID: 830,
  },
  {
    stateID: 826,
    logText: "我颤抖着将仪式刀从右眼中拔出，",
    nextStates: [{ possibility: 2.0, stateID: 827 }],
    skipStateID: 830,
  },
  {
    stateID: 827,
    logText: "强忍着疼痛，然后将它插入左眼。",
    nextStates: [{ possibility: 2.0, stateID: 828 }],
    skipStateID: 830,
  },
  {
    stateID: 828,
    logText: "我将黑布遮盖住双眼，",
    nextStates: [{ possibility: 2.0, stateID: 829 }],
    skipStateID: 830,
  },
  {
    stateID: 829,
    logText: "我觉察了——",
    nextStates: [{ possibility: 2.0, stateID: 830 }],
  },
  {
    stateID: 830,
    logText: "视觉，是低级的洞察，",
    nextStates: [{ possibility: 2.0, stateID: 831 }],
  },
  {
    stateID: 831,
    logText: "我已突破桎梏。",
    nextStates: [{ possibility: 2.0, stateID: 832 }],
  },
  {
    stateID: 832,
    logText: "我不需要视觉，就能知晓周身一切",
    nextStates: [{ possibility: 2.0, stateID: 323 }],
  },
  {
    stateID: 833,
    logText: "我开始了书上的仪式“铁意仪式”——",
    nextStates: [{ possibility: 2.0, stateID: 834 }],
  },
  {
    stateID: 834,
    logText: "【食欲】",
    nextStates: [{ possibility: 2.0, stateID: 835 }],
  },
  {
    stateID: 835,
    logText: "【1kg动物肌肉】",
    nextStates: [{ possibility: 2.0, stateID: 836 }],
  },
  {
    stateID: 836,
    logText: "【一瓶500mL血液】",
    nextStates: [{ possibility: 2.0, stateID: 837 }],
  },
  {
    stateID: 837,
    logText: "我将肌肉放在仪式圆圈的中央。",
    nextStates: [{ possibility: 2.0, stateID: 838 }],
  },
  {
    stateID: 838,
    logText: "将瓶中的血液倒在肌肉上，让其浸泡。",
    nextStates: [{ possibility: 2.0, stateID: 839 }],
  },
  {
    stateID: 839,
    logText: "点燃火，将混合物放入铁锅中，顺时针搅拌，同时唱诵：",
    nextStates: [{ possibility: 2.0, stateID: 840 }],
  },
  {
    stateID: 840,
    logText: "“吾意如铁，吾力不可破，由是得肌肉之力”。",
    nextStates: [{ possibility: 2.0, stateID: 841 }],
  },
  {
    stateID: 841,
    logText: "“吾意如铁，吾力不可破，由是得肌肉之力。”",
    nextStates: [{ possibility: 2.0, stateID: 842 }],
  },
  {
    stateID: 842,
    logText: "“吾意如铁，吾力不可破，由是得肌肉之力。”",
    nextStates: [{ possibility: 2.0, stateID: 843 }],
  },
  {
    stateID: 843,
    logText: "我服用了这团混合物",
    nextStates: [{ possibility: 2.0, stateID: 844 }],
  },
  {
    stateID: 844,
    logText: "仪式结束",
  ...
  {
    stateID: 845,
    logText: "我开始了书上的仪式“心之咒语”。",
    nextStates: [{ possibility: 2.0, stateID: 846 }],
  },
  {
    stateID: 846,
    logText: "我倒立着，闭上眼睛，用我的意识聚集在我的心脏上。",
    nextStates: [{ possibility: 2.0, stateID: 847 }],
  },
  {
    stateID: 847,
    logText: "我用我的意识将我的心脏变成一个黑洞，然后将我的意识投入其中。",
    nextStates: [{ possibility: 2.0, stateID: 848 }],
  },
  {
    stateID: 848,
    logText: "口颂咒语：",
    nextStates: [{ possibility: 2.0, stateID: 849 }],
  },
  {
    stateID: 849,
    logText: "“赐我以力，强我以壮”",
    nextStates: [{ possibility: 2.0, stateID: 850 }],
  },
  {
    stateID: 850,
    logText: "“举重若轻，行远若近，抗敌若无”",
    nextStates: [{ possibility: 2.0, stateID: 851 }],
  },
  {
    stateID: 851,
    logText: "“赐我以力，强我以壮”",
    nextStates: [{ possibility: 2.0, stateID: 852 }],
  },
  {
    stateID: 852,
    logText: "“扛山担海，奔走如飞，御敌如神”",
    nextStates: [{ possibility: 2.0, stateID: 853 }],
  },
  {
    stateID: 853,
    logText: "我感受到了一种奇异的力量，它在我的心脏中流动，",
    nextStates: [{ possibility: 2.0, stateID: 854 }],
  },
  {
    stateID: 854,
    logText: "我感受到了一种强大的力量，它在我的身体中流动，",
    nextStates: [{ possibility: 2.0, stateID: 855 }],
  },
  {
    stateID: 855,
    logText: "我感受到了一种强大的力量，它在我的意识中流动，",
    nextStates: [{ possibility: 2.0, stateID: 856 }],
  },
  {
    stateID: 856,
    logText: "我感受到了一种强大的力量，它在我的灵魂中流动。",
    nextStates: [{ possibility: 2.0, stateID: 857 }],
  },
  {
    stateID: 857,
    logText: "仪式结束。",
