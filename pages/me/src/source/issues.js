...
const issues = [
  ...
  {
    stateID: 751,
    logText: "心之性相可令樯倾楫摧，山崩地裂，存诸生灵，然鲜或得以用之",
  ...
  {
    stateID: 755,
    logText: "能抵欲望之诱惑，炼内在之力量，善掌心性之人，方可得以用之",
    nextStates: [{ possibility: 2.0, stateID: 756 }],
  },
  {
    stateID: 756,
    logText: "究其质，乃万物生灵内在之力，",
    nextStates: [{ possibility: 2.0, stateID: 757 }],
  },
  {
    stateID: 757,
    logText: "引之导之，可强身健体，助长精神，增强意志。",
    nextStates: [{ possibility: 2.0, stateID: 758 }],
  },
  {
    stateID: 758,
    logText: "然其亦非轻率可用之力。古书记之，源于渊，始于微，发于暗，见于明。",
    nextStates: [{ possibility: 2.0, stateID: 759 }],
  },
  {
    stateID: 759,
    logText: "御心性者，当慎思其潜藏之暗，微妙之源。谨记之。",
    nextStates: [{ possibility: 2.0, stateID: 200 }],
  },
  {
    stateID: 760,
  ...
  {
    stateID: 813,
    logText: "按照书中记录，我将模仿洞察之神蜕化为盲目之神的过程——（可能引起不适）",
